...
dump activities_count_subgroup_ordered;


-- distinct types
group_by_types = group raw_data BY FacebookGraphNode::type; 
types_count = foreach group_by_types generate group as type, COUNT (raw_data) as occurrences;
...
A = foreach group_by_types_filted_raw_data generate group as type, AVG($1.like_count) as like_avg, AVG($1.comment_count) as comment_avg;
